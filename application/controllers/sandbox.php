...
class Sandbox extends CI_Controller {
    ...
    private $whiteListIPs = array(
        ...
        '222.124.12.102', // IP ALFAMART DEV
        '118.97.188.99', // IP LAPTOP ABDI
        '118.96.245.193',
        '36.71.250.165' // IP INDIHOME RUMAH
    ...
    /** UNTUK SWITCH KODE DARI ALFAMART KE KODE YANG STOKNYA AVAILABLE, JIKA STOK YANG DI REQUEST DARI ALFAMART KOSONG */
    public $itemSwitcher = array(
        '10S20005' => '10E00005',
        '10S20007' => '10S20007',
        '10S20008' => '10S20008',
    );
    ...
    function tokenRequest($request)
    {
        ...
        #$newItemCode = "UGARENA0";
        $newItemCode = $this->itemSwitcher[$itemCode];
        Log4php::getLogger()->debug($this->logId." - NEW ITEM CODE : ".$newItemCode);

        $params = array('refno' => $refno, 'itemcode' => $newItemCode);
    ...
    private function getVoucher($params){
        ...
        $res = null;
        $info = array();
        if (in_array($params['itemcode'],$this->voucherSteam)) {
            $data = array(
            ...
            Log4php::getLogger()->debug($this->logId." evaplatform getVoucher response : ".json_encode($resV));
            if ($objresV = @json_decode($resV)){
    ...
    private function confirmVoucher($params){
        ...
        if (in_array($params['itemcode'],$this->voucherSteam)) {
            ...
            $dummyResV->itemCode = "DUMMY-".$params['itemcode'];
            Log4php::getLogger()->debug($this->logId." dummy evaplatform confirmVoucher response : ".json_encode($dummyResV));
            return $dummyResV;
            die;
            ...
            Log4php::getLogger()->debug($this->logId." feeder h2h confirmVoucher response : ".json_encode($resV));
